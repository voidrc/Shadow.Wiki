...
A **virtual machine** lets you run a second operating system as a window on your current computer. Your real system is never touched.
...
Security tools mostly run on **Linux**. You don't need to install Linux on your real machine — you'll run it inside a VM (explained in Step 1).
...
### Step 3 — Creating your first VM (Kali Linux example)
...
---
> If you already use Linux and want some advanced shit then look for [Qemu/KVM](Arch/Qemu.md) guide. This guides you to set-up Qemu environment on Arch System.
